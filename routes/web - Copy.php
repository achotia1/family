	...
	Route::group(['prefix' => 'admin','middleware' => 'AdminGeneral','namespace'=>'Admin'], function ()
	{
		...
		-------------------------------------------------*/
			Route::group(['middleware' => ['AdminAuthenticate']],function()
			{
				...
				// Dashboard
				Route::group(['middleware' => ['permission:dashboard']], function () use($PREFIX)
				{
				...
				// Raw Material
				/*Route::group(['middleware' => ['permission:manage-raw-material']], function () use($PREFIX)
				{*/
					Route::get('/materials/getRecords',  'RawMaterialController@getRecords');
					Route::post('/materials/bulkDelete',  'RawMaterialController@bulkDelete');
					Route::resource('materials', 'RawMaterialController', ['as' => $PREFIX]);
				/*});*/
