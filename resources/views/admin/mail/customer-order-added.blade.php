    ...
    <td bgcolor="#ffffff" align="center">
        ...
        <tr>
          <td><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" >
              <tr>
                <td>Hello {{ $company->user_name ?? 'Customer' }} ,<br/> <br/>Your order has been submitted and its under review. When it will be confirmed, you will get an update via sms and email. <br/> Please find your order details below:<br/><br/>
                </td>
              </tr>
              <tr>
