  ...
  <tr>
    <td bgcolor="#ffffff" align="center">
        ...
        @if($orderinfo->mail_type=='user')
          <tr>
            <td style=""><h2 style="text-align: center; font-size:18px;text-transform: uppercase;">Welcome to {{ $orderinfo->company->name ?? 'Company' }}</h2></td>
          </tr>
        @endif
        <tr>
          <td><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="">
              <tr>
                <td>
                  @if($orderinfo->mail_type=='user')
                    Hello {{ $orderinfo->contact_name }}, <br/><br/> Your Order No: {{ $orderinfo->order_number }} is dispatched
                  @else
                    Hello Admin, <br/><br/> Order No: {{ $orderinfo->order_number }} is dispatched
                  @endif
                </td>
              </tr>
              <tr>
