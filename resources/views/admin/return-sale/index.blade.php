...
<section class="content">
    <div class="box">
        ...
        <div class="box-header align-right">           
            <a href="{{ route($modulePath.'create') }}" class="btn btn-primary pull-right" >Add Returned Sale</a>            
            ...
            <table id="listingTable" class="table table-bordered table-striped" style="width:100%" >
                <thead class="blue-border-bottom">
                    <tr>
                        ...
                        <th class="w-100-px">Return Date</th>
...
<script type="text/javascript" src="{{ url('assets/admin/js/return-sale/index.js') }}"></script>
