        ...
        <div class="box-body">
            <div class="table-responsive"  id="tblPrint">
                <table class="table" border="1px;">
                    <tbody>
                        <tr class="trExpense">
                            <td colspan="6" class="title"><b>Returned Sale</b>
                        ...
                        <tr>                            
                            ...
                            <td>                            
                            {{ $object->assignedSale->invoice_no ?? "" }}
                            </td>

                            <td><b>Invoice Return Date:</b></td>
                            <td>
                                {{ date('d-m-Y', strtotime($object->return_date))}}
                            </td>
                        </tr>
                        <tr>                            
                            <td><b>Customer Name:</b></td>
                            <td colspan="3">
                                {{ $object->assignedCustomer->contact_name }} ({{ $object->assignedCustomer->company_name }})
                            </td>
                        </tr>
                        <!-- <tr>                            
                        ...
                        <tr class="trExpense">
                            <td colspan="4" class="title"><b>Returned Product Details</b></td>
                        </tr>
                        <tr>
                            <td><b>Sr.No</b></td>
                        ...
                        <tr>
                             ...
                             <td><strong> {{ number_format($total_qty,2) }} kg </strong></td>
