...
<section class="content">
    <div class="box">
        <div class="box-header align-right">
        	<span class="ltime-interval interval-lable">Material not used for more than : </span>
            ...
            <table id="listingTable" class="table table-bordered table-striped" style="width:100%" >
                <thead class="blue-border-bottom">
                    <tr>
                        ...
                        <th class="w-10">Lot Number</th>
                        <th class="w-20">Material</th>                        
                        <th class="w-5">Lot Balance</th>
                        <th class="w-10">Last Used Date</th>
                        <th class="w-10">Material In Date</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript" src="{{ url('assets/admin/js/reports/agedMaterial.js') }}"></script>
