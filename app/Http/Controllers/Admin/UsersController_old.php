...
class UsersControllerOld extends Controller
{
    ...
    public function create()
    {
        // Default site settings
        $this->ViewData['moduleTitle']  = 'Manage '.$this->ModuleTitle;
        $this->ViewData['moduleAction'] = 'Add '.str_singular($this->ModuleTitle);
        $this->ViewData['modulePath']   = $this->ModulePath;
    ...
    public function getRecords(Request $request)
    {
        ...
        ------------------------------*/
            ...
            //if(auth()->user()->company_id>0){
                  ...
                  //               ->whereIn('users.company_id',[$company_id,0]);
    ...
    public function _sendRegisterMail($collection){
        $mail_collection = new $collection;
        $mail_collection->name = $collection->name;
