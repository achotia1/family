...
class StoreIssuedMaterialController extends Controller
{
   ...
   /* public function show($encID)
    ...
    public function edit($encID)
    {
        ...
        $data = $this->BaseModel->where('store_issued_materials.id', base64_decode(base64_decode($encID)))->where('store_issued_materials.company_id', $companyId)->first();
        if(empty($data)) {            
    ...
    public function getRecords(Request $request)
    {
        ...
        ->where('store_issued_materials.company_id', $companyId);
        ## GET TOTAL COUNT
